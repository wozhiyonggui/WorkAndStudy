...
#操作前先手动全选表格转格式为文本
path_config_battlepass = r'E:\WorkAndStudy\Python\config-sus\battlepass.xlsx'
path_config_drop = r'E:\WorkAndStudy\Python\config-sus\drop.xlsx'
path_result_battlepass = r'E:\WorkAndStudy\Python\result-sus\result_battlepass.xlsx'
#修改待测试BP起初ID参数
a = 100001
b = 100020
#读取battlepass
