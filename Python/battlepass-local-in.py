...
#操作前先手动全选表格转格式为文本
#修改待测试BP起初ID参数
path_config_battlepass = r'C:\Users\jinyan\PycharmProjects\Python\config\battlepass.xlsx'
path_config_drop = r'C:\Users\jinyan\PycharmProjects\Python\config\drop.xlsx'
path_result_battlepass = r'C:\Users\jinyan\PycharmProjects\Python\result\result_battlepass.xlsx'
a = 100001
b = 100050
#读取battlepass
...
#对比数据
input_path = r'C:\Users\jinyan\PycharmProjects\Python\result\result_battlepass.xlsx'
output_path = r'C:\Users\jinyan\PycharmProjects\Python\result\result_battlepass_color.xlsx'
sheet = 'bplevel'
client1 = 3
server1 = 8
client2 = 13
