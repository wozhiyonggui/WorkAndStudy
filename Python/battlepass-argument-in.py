...
#命令行参数
parser.add_argument('--path_config_battlepass', type=str, default=r"C:\Users\jinyan\PycharmProjects\Python\config\battlepass.xlsx")
parser.add_argument('--path_config_drop', type=str, default=r"C:\Users\jinyan\PycharmProjects\Python\config\drop.xlsx")
parser.add_argument('--path_result_battlepass', type=str, default=r"C:\Users\jinyan\PycharmProjects\Python\result\result_battlepass.xlsx")
parser.add_argument('--a', type=int, default=900001)
parser.add_argument('--b', type=int, default=900050)
parser.add_argument('--input_path', type=str, default=r'C:\Users\jinyan\PycharmProjects\Python\result\result_battlepass.xlsx')
parser.add_argument('--output_path',type=str, default=r'C:\Users\jinyan\PycharmProjects\Python\result\result_battlepass-color.xlsx')
