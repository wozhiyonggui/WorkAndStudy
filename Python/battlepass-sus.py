...
b = 600050
#操作前先手动全选表格转格式为文本
path_config_battlepass = r'E:\Python\config-sus\battlepass.xlsx'
path_config_drop = r'E:\Python\config-sus\drop.xlsx'
path_result_battlepass = r'E:\Python\result-sus\result_battlepass.xlsx'
