...
dropset_BPLevel_paid = [int(i) for i in dropid_BPLevel_paid]
...
for dropid_paid in dropset_BPLevel_paid:
    ...
    oneline_paid = data_drop_paid[oneidx_paid].values[0]
...
dropset_BPLevel_free = [int(i) for i in dropid_BPLevel_free]
...
for dropid_free in dropset_BPLevel_free:
    ...
    oneline_free = data_drop_free[oneidx_free].values[0]
